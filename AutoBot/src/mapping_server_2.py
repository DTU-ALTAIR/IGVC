...
class Gridmap:
    def __init__(self):
        ...
        self.map_center_x         = rospy.get_param('~map_center_x', -3.0)
        self.map_center_y         = rospy.get_param('~map_center_y', -3.5)
        self.map_orientation_x         = rospy.get_param('~map_orientation_x', 3.141)
        self.map_orientation_y         = rospy.get_param('~map_orientation_y', 0)
        self.map_orientation_z         = rospy.get_param('~map_orientation_z', 1.5707)
